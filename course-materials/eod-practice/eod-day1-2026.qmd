...
Nice work! You have now rerun a complete data science workflow and changed three things in it
(hopefully!): the variable you averaged, the grouping key, and a chart label. Each time, you read
