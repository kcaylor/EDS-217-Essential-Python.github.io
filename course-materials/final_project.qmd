...
subtitle: "Creating a Comprehensive 10-Step Data Science Workflow"
jupyter: eds217_2026
format: 
    html:
        toc: true
...
These are the same ten steps described on [The Data Science Workflow](the-data-science-workflow.qmd) page.
...
Your notebook should include each of the ten steps, even if you don't need to do much in each of them. Step 9 is the one most likely to be short: if your project uses a single table, say so under that heading and move on.

:::{.callout-note}
You can include additional visualizations as part of your data exploration (step 2), or anywhere else it is helpful.
:::
...
## Using Google Drive to store your .csv files.

Once you've found a .csv file (or .csv files) that you want to use, you should:
