...
# Note - We could also use set_index to accomplish the same thing after loading:
# df.set_index('entity', inplace=True)
# However, using index_col during loading is more efficient!
```
...
- Which pandas methods for data selection and filtering did you find most useful?
- How did the data cleaning and manipulation techniques help you explore the dataset?
- What patterns did you notice in the environmental impact data?
- What aspects of pandas data manipulation do you want to practice more?
...
## 📚 **Additional Content for Instructors**

:::{.callout-important title="Note for Instructors"}
The sections below (6-8) use advanced concepts not yet taught in Day 5, including seaborn visualization. These are provided for instructor reference and could be used as:
- **Day 7 extension**: After seaborn is introduced
- **Advanced examples**: For students who finish early
- **Future capstone**: Integration of visualization with data analysis
:::

### 6. Correlation Analysis (Advanced - Day 7+ Content)
...
b) Create a heatmap to visualize these correlations. *(Uses seaborn - Day 7 concept)*
```{python}
#| echo: true
#| include: true
#| eval: false

# NOTE: This section requires seaborn, taught in Day 7
...
### 7. Using Pandas styles (Advanced pandas concept)
...
## 8. Bonus Challenge (Advanced function concepts)
...
## 📝 **Main Activity Conclusion**

This concludes the core Day 5 activity focusing on pandas data manipulation and analysis skills. The advanced sections above can be used for extension activities or future lessons.
