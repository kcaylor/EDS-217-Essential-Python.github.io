...
```markdown
# Day 7: Session A - Visualizations, Part II

[Link to session webpage](https://eds-217-essential-python.github.io/course-materials/interactive-sessions/7a_visualizations_2.html)
...
# Import data
bsrn = pd.read_csv(
    'https://eds-217-essential-python.github.io/data/bsrn_gob_2019-10.csv',
    index_col=0,
    parse_dates=True
    )
