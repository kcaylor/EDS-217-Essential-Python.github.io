...
conda install jupyter jupyterlab ipykernel numpy pandas matplotlib seaborn scipy scikit-learn

# Register the environment with Jupyter
python -m ipykernel install --user --name eds217_2026 --display-name "Python 3.11 (EDS 217 2026)"
```

When using JupyterLab, you can then select "Python 3.11 (EDS 217 2026)" as your kernel.
