---
title: "Day 7: 🙌 Coding Colab Answer Key"
...
sns.pairplot(penguins, height=2, aspect=1)
plt.show()

# Create a pairplot with species information
sns.pairplot(penguins, hue='species', height=2, aspect=1)
plt.show()
```
...
sns.lmplot(data=penguins, x='bill_length_mm', y='bill_depth_mm', hue='species', height=4, aspect=1.5)
