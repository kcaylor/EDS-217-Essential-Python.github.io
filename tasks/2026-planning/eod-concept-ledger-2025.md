...
- 📖 in-EOD: the EOD itself teaches it via callout (this is the "backfill inside the EOD" pattern; make it deliberate in 2026)
...
**2026 note:** This is the strongest existing asset for the "whole game first" approach. The preview framing (resolved in 2025) works. It is a candidate for becoming the template every day follows in miniature.
...
5. **In-EOD callout teaching already exists** (`~`, `.copy()` on D4; set-intersection tip on D5) and works. In 2026 this becomes a deliberate, named mechanism.
