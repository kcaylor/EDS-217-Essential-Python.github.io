...
The Visualizing column is empty on purpose. In this course, visualization does not come from a
DataFrame method. It comes from `matplotlib` and `seaborn`, which take a DataFrame or a Series
as an argument instead. See the [matplotlib](matplotlib.qmd) and [seaborn](seaborn.qmd)
cheatsheets.
