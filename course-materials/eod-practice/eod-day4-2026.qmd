...
This dataset was assembled one study at a time. Nobody designed this dataset. Most of the environmental
data you will ever be handed was put together the same way.

You have already seen this file twice today. Now, you will use the raw data to answer
the question: Is there more plastic in the Pacific than the Atlantic?
...
Everything below is built from these three patterns, plus two more you learned yesterday.
...
The `.year` is the request for the year of that date string. **Dates get a full session on Day 6.**
...
Part 2 requires some judgement, so more than one answer here is defensible. Every
...
`ocean`, `year`, `log10_measurement`, and `my_class`. The twenty-two columns you downloaded
did not have the answer to the journalist's question in them, and the four columns you made yourself are where you found it!
