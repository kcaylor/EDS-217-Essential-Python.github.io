...
The resulting file is small, relatively clean by the standards of anything you have opened this week, and it contains
a key result that you cannot really express without a figure. This isn't a result that is *easier* to convey with a figure, but rather one that a table of summary statistics would likely steer you away from.

Your task this afternoon is to develop that figure and reveal the underlying pattern.
...
All the patterns we will use are from this morning.
...
called **Simpson's paradox**. It is not a curiosity, but rather one of the most common ways that a
perfectly correct summary of a dataset produces a conclusion that is the reverse of the truth. 
