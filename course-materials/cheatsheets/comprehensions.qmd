...
:::{.callout-note title="Read these, do not write them in EDS 217"}
This course asks you only to **read** comprehensions and predict what they produce, which is
what live-coding session 5d covers. Nothing in EDS 217, including the final project, requires
you to write one. Use this page when you meet a comprehension in code you have inherited.
:::
