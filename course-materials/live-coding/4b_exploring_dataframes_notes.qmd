...
url = "https://eds-217-essential-python.github.io/data/basic_data.csv"
df = pd.read_csv(url)
print(df.head())
```
...
url = "https://eds-217-essential-python.github.io/data/tab_data.tsv"
...
url = "https://eds-217-essential-python.github.io/data/no_header.csv"
...
url = "https://eds-217-essential-python.github.io/data/large_dataset.csv"
...
url = "https://eds-217-essential-python.github.io/data/missing_values.csv"
...
url = "https://eds-217-essential-python.github.io/data/zip_code_database.csv"
...
- [Pandas IO Tools (Text, CSV, HDF5, …)](https://pandas.pydata.org/pandas-docs/stable/user_guide/io.html)